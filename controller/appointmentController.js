       ...
       !doctor_lastName ||
        !address 
         ...
         if(isConflict.length > 1){
            return next(new ErrorHandler("Doctors Conflict! Please Contact Throgh Email or Phone!",404))
         }
...
export const updateAppointmentStatus  = catchAyncErrors(async(req,res,next)=>{
   const {id} = req.params;
   ...
   res.status(200).json({
      success : true,
      message:"Appointmemt Status Updated",
      appointment,
   })
})
